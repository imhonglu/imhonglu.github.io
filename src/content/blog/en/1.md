...
const validate = ajv.compile({
  type: 'object',
  // ❌ Even when starting to input here, it doesn't infer valid keywords for 'object' type
});
...
First, I wrote a `cli` for repository synchronization and utility functions like [gitFetch](#gitfetch) were also written.
...
Your opinions and suggestions will drive this library's continued improvement. Thank you! 🚀
