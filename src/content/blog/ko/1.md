...
JSON Schema 팀에서는 [JSON-Schema-test-suite](https://www.notion.so/19188465d81580879b25d9174a18da7a?pvs=21) 저장소를 통해 다양한 JSON Schema 테스트 케이스를 제공하고 있었습니다.
...
그런데, JSON Schema 팀이 이미 **[Bowtie](https://www.notion.so/19188465d81580879b25d9174a18da7a?pvs=21)**라는 강력한 CLI 테스팅 도구를 제공하고 있다는 사실을 알게 되었습니다.
